...
app.get("/recipeStream", (req, res) => {
  ...
  const prompt = [];
  prompt.push("You are an experienced culinary teacher with years of teaching students at all skill levels (beginner, intermediate, and expert). Generate a recipe that incorporates the following details:");
  ...
  ///Break up the task into multiple steps to aid in chain-of-thought prompting
  prompt.push(
